...
def dibujar(screen, candidata, listaIzq, listaMedio, listaDer, posicionesIzq ,
    ...
    #Linea del piso
    pygame.draw.line(screen, COLOR_LINEAS, (0, ALTO-70) , (ANCHO, ALTO-70), 5)

    #linea vertical
    pygame.draw.line(screen, COLOR_LINEAS, (ANCHO//3, ALTO-70) , (ANCHO//3, 0), 5)

    #linea vertical
    pygame.draw.line(screen, COLOR_LINEAS, (2*ANCHO//3, ALTO-70) , (2*ANCHO//3, 0), 5)
